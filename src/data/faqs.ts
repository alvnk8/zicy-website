...
export const brandsFaqs: Faq[] = [
  ...
  },
  {
    ...
    a: `No, and that's the common trap. Only 12% of AI-cited links also rank in Google's top 10 (Ahrefs, 15,000 prompts, 2025), and just 38% of AI Overviews citations now come from pages ranking in the top 10, down from 76% a year earlier (Ahrefs, 863,000 keywords, 2026). A strong Google position no longer guarantees a place in the answer; AI visibility runs on different signals.`,
  },
  {
